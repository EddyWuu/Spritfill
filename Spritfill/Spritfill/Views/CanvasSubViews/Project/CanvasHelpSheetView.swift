            ...
            ScrollView {
                VStack(spacing: 20) {
                    ...
                    helpSection(title: "Tools", icon: "paintbrush") {
                        ...
                        toolRow(icon: "line.diagonal", name: "Line", description: "Drag to draw a straight line between two points. Uses the selected color")
                        toolRow(icon: "rectangle", name: "Rectangle", description: "Drag to draw a rectangle between two corners. Tap again while selected to switch between Outline and Filled mode")
                        ...
                        HStack(alignment: .top, spacing: 12) {
                            ...
                            VStack(alignment: .leading, spacing: 4) {
                                Text("Questions or Feedback?")
                                    .font(.subheadline)
                                    .fontWeight(.medium)
                                Text("Encountering a bug, have a feature request, or just want to share a suggestion? Reach out here:")
                                    .font(.caption)
                                    .foregroundColor(.secondary)
